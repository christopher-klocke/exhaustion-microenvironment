...
plots_store = '/Users/klockec/Documents/data/analysis_files/p3/li_results_plots'
...
li_T_dpt_filename = 'li_T_dpt.h5ad'
...
adata_li_T.uns['iroot'] = np.flatnonzero(adata_li_T.obs['leiden'] == '1')[0]
