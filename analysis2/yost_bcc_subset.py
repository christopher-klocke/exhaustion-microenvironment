...
## load the data
adata_yost = sc.read_h5ad(dir + yost_bcc_full_filename)

## subset the data
cd8_types = ['CD8_mem_T_cells', 'CD8_act_T_cells', 'CD8_ex_T_cells', 'Tcell_prolif']
adata_yost_T = adata_yost[adata_yost.obs['cluster_original'].isin(cd8_types)]
...
adata_yost_T.write_h5ad(dir + yost_bcc_just_T_filename)
