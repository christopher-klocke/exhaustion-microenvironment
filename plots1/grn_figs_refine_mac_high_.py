...
lower_score_threshold = 5
higher_score_threshold = 25
...
links1_update = cut_by_scores(links=links1, scores_df=li_links_scores, score_threshold=lower_score_threshold, edge_weights=True, as_df=True)
links2_update = cut_by_scores(links=links2, scores_df=yost_links_scores, score_threshold=lower_score_threshold, edge_weights=True, as_df=True)
links3_update = cut_by_scores(links=links3, scores_df=wang_links_scores, score_threshold=lower_score_threshold, edge_weights=True, as_df=True)
...
links_agg1.to_csv((out_dir_agg + 'mac_high_annotations_rerun_2levels.csv'), index=False)
...
nx.write_graphml(G=G, path=(out_dir_agg + "mac_high_agg_new_rerun_2levels.graphml"))
