...
# setup
dataset1_results = "/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/mod1/wang_parallel_tfs/combined_bh.csv"
dataset1_links = "/Users/klockec/OneDrive - Oregon Health & Science University/data_backup_rws07890/data_january2023_backup/data/analysis_files/p3/pyscenic_runs/p3/wang_run/ctx_output1.gmt"
#mac_high_graph_path = "/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/mod1/wang_grn_graphs/mac_high_grn1.graphml"
#mac_high_graph_path = "/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/mod1/wang_grn_graphs/mac_high_grn2.graphml"
#mac_high_graph_path = "/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/mod1/wang_grn_graphs/mac_high_grn3_tumor_tumor_viral.graphml"
mac_low_graph_path = "/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/mod1/wang_grn_graphs/mac_low_grn3.graphml"
...
#sig_threshold = 0.00000000001
sig_threshold = 0.0000000000000001
#sig_threshold = 0.000000000000000001
...
#tumor_viral_tfs = ['ETV3', 'FOXP3', 'HIC1', 'IRF1', 'NFKB1', 'NFKB2', 'STAT3']
#links_tumor_tumor_viral = [i for i in links if (i[0] in tumor_viral_tfs and i[1] in tumor_viral_tfs)]


#print(str(len(links_tumor_tumor_viral)))
...
#G = nx.from_edgelist(links_tumor_tumor_viral)

#G = nx.DiGraph()
#G.add_edges_from(links)

#nx.write_graphml(G=G, path=mac_high_graph_path)  ###########
nx.write_graphml(G=G, path=mac_low_graph_path)  ###########
