...
size = 20
for gene in genes1:
    sc.pl.umap(adata, color=gene, size=size, show=False, save='_li_t_' + gene + '_2.pdf')
sc.pl.umap(adata, color='monocle3_pseudotime', size=size, show=False, save='_li_t_pt2.pdf')
