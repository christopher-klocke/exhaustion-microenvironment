...
datasets1 = {'t1': links1_update, 't2': links2_update, 'v1': links3_update}
links_agg1 = links_agg(**datasets1)
links_agg1.to_csv((out_dir_agg + 'mac_high_annotations_rerun_15.csv'), index=False)
...
#print(links1_update)
#print(links2_update)
#print(links_agg1[links_agg1['TF'] == tf])
#print(links_agg1[links_agg1['target'] == tf])
...
G = nx.from_pandas_edgelist(links_agg1_tograph, 'source', 'target', ['importance'])
nx.write_graphml(G=G, path=(out_dir_agg + "mac_high_agg_new_rerun_15.graphml"))
