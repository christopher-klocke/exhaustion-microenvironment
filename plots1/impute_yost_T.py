...
#yost_just_T_filename = 'data/yost_data/yost_dd_T_viz_ready_v2.h5ad'
#yost_imputed_filename = 'data/yost_data/yost_T_imputed_v2.h5ad'
#yost_just_T_filename = 'data/yost_data/yost_dd_T_viz_ready_v4.h5ad'
#yost_imputed_filename = 'data/yost_data/yost_T_imputed_v4.h5ad'
yost_just_T_filename = 'data/yost_data/yost_T_wang_genes_v1.h5ad'
yost_imputed_filename = 'data/yost_data/yost_T_imputed_wang_v1.h5ad'

## load the data
adata_yost = sc.read_h5ad(dir + yost_just_T_filename)
