...
# setup
df_filename = '/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/mod1/tumor_tumor_overlap_run6/stage1_results.csv'
plots_store = '/Users/klockec/OneDrive - Oregon Health & Science University/data/analysis_files/p3/manuscript_figs/venns/'
...
for res in range(df.shape[0]):
    ...
    venn2(subsets=(left, right, shared), set_labels=('melanoma', 'BCC'))
