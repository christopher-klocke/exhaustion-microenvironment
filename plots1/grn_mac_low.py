...
links_agg1.to_csv((out_dir_agg + 'mac_low_annotations_agg_' + file_suffix + '.csv'), index=False)
df.to_csv((out_dir_agg + "mac_low_tf_annotation_" + file_suffix + ".csv"), index=False)  # node annotation file -- save
...
nx.write_graphml(G=G, path=(out_dir_agg + "mac_low_agg_" + file_suffix + ".graphml"))
