"""See more extensive notes in previous version of file. Most recent configuration described by run in mouse_run3_notes.ipynb as of 8/8/21. """
# modify for compatibility with loom file:
ATTRIBUTE_NAME_CELL_IDENTIFIER = "CellID"
ATTRIBUTE_NAME_GENE = "Gene"

#ATTRIBUTE_NAME_CELL_IDENTIFIER = "obs_names"
#ATTRIBUTE_NAME_GENE = "var_names"
...
from pyscenic.cli.utils import ( ## added pyscenic.cli
    load_exp_matrix,
    load_signatures,
    save_matrix,
    ...
    load_modules,
    append_auc_mtx,
    #### REMOVING 'ATTRIBUTE_NAME_CELL_IDENTIFIER' and 'ATTRIBUTE_NAME_GENE'
)
from pyscenic.cli.utils import is_valid_suffix, suffixes_to_separator ## added pyscenic.cli
